    ...
    <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        {evolution ? (
          ...
          <div>
            ...
            {/* <!-- Modal footer --> */}
            <div className="flex items-center p-[0.5rem] space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                <button data-modal-toggle="defaultModal" type="button" className="text-white bg-slate-600 hover:bg-red-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-slate-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Edit Pokemon</button>
            </div>
        </div>
    </div>
</div>
